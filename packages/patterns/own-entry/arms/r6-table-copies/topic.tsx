// EXPERIMENT (own-entry, arm `r6-table-copies`): a copy of
...
export interface TopicInput {
  ...
  /** EXPERIMENT (r6-table-copies): the name the board allocated for this topic, stored
...
export default pattern<TopicInput, TopicOutput>(
  (
    ...
    // EXPERIMENT (r6-table-copies): the name is this topic's own stored input.

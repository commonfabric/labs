...
export interface TopicInput {
  ...
  /** EXPERIMENT (r4-adopt): the name the board allocated for this topic, stored
   * here by the create that filed it. */
  shortName?: string;

  /** EXPERIMENT (r4-adopt): this topic's own entry, the reference the board
...
/** EXPERIMENT (r4-adopt): what a topic shows of a topic that mentions it. */
export interface TopicBacklinkCopy {
  title: string;
  shortName: string;
}

/** EXPERIMENT (r4-adopt): what the board holds about one topic. */
...
export default pattern<TopicInput, TopicOutput>(
  (
    ...
    // EXPERIMENT (r4-adopt): the name is this topic's own stored input.

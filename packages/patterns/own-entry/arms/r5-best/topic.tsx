...
export interface TopicInput {
  ...
  /** EXPERIMENT (r5-best): the name the board allocated for this topic, stored
   * here by the create that filed it. */
  shortName?: string;

  /** EXPERIMENT (r5-best): this topic's own entry, the reference the board
   * handed over when it filed the topic. */
  ownEntry?: ReadonlyCell<OwnEntry | undefined>;
}

/** EXPERIMENT (r5-best): what a topic shows of a topic that mentions it. */
export interface TopicBacklinkCopy {
  title: string;
  shortName: string;
}

/** EXPERIMENT (r5-best): what the board holds about one topic. */
 ...
 */
/** EXPERIMENT (r5-best): the inbound references this topic's entry carries. */
...
export default pattern<TopicInput, TopicOutput>(
  (
    ...
    // EXPERIMENT (r5-best): the name is this topic's own stored input.

...
export interface TopicInput {
  ...
  /** EXPERIMENT (r3-one-entry): the name the board allocated for this topic, stored
   * here by the create that filed it. */
  shortName?: string;

  /** EXPERIMENT (r3-one-entry): this topic's own entry, the reference the board
   * handed over when it filed the topic. */
  ownEntry?: ReadonlyCell<OwnEntry | undefined>;
}

/** EXPERIMENT (r3-one-entry): what a topic shows of a topic that mentions it. */
 ...
 */
/** EXPERIMENT (r3-one-entry): the inbound references this topic's entry carries. */
...
export default pattern<TopicInput, TopicOutput>(
  (
    ...
    // EXPERIMENT (r3-one-entry): the name is this topic's own stored input.
